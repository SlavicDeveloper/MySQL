...
# Задание 2 (преобразовать created_at и updated_at к типу DATETIME) Операторы, фильтрация, сортировка, ограничение 

  created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) COMMENT = 'Покупатели';

# Задание 1 (добавить поля created_at и  updated_at c текущими датой и временем) Операторы, фильтрация, сортировка, ограничение 
